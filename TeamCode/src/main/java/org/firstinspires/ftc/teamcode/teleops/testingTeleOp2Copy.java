...
@TeleOp
public class testingTeleOp2Copy extends BaseRobot {
    ...
    public void loop() {
        ...
        if (slowMode) Control.drive.weirdTankanumDrive(gamepad1.right_stick_y/5, gamepad1.left_stick_y/5, gamepad1.left_stick_x/5, 0.5);
        else Control.drive.weirdTankanumDrive(gamepad1.right_stick_y, gamepad1.left_stick_y, gamepad1.left_stick_x, 0.5);
